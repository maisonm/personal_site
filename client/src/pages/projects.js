...
import {
  ProjectsPageContainer, ProjectsOverviewContainer, OverviewHeading, OverviewText, ProjectCardsContainer, ProjectCardBox, ProjectCard, ProjectImage, ProjectDetails, Details,
        ...
        <ProjectCard>
          ...
          <ProjectDetails>
            <Details>
              ...
              <p>
                 This website is built with React, Gatsby, &amp; GraphQL, all hosted via Heroku. Blog posts are generated from markdown files that support code block highlighting via PrismJS and inserting images. The CSS was written with styled-components. This site periodically undergoes changes and updates as I learn more.
              </p>
        ...
        <ProjectCard>
          ...
          <ProjectDetails>
            <Details>
              ...
              <p>
                 This handicap calculator was a tool I made with vanilla Javascript to help me quickly gauge where my handicap was after each round of golf. There are way better calcultors out there, but I needed something simple and to the point. Just the basics here; vanilla Javascript, a bit of math, HTML5, and CSS3. I personally use this quite often.
              </p>
              <a href="https://www.github.com"> | Github Repo | </a>
            </Details>
          </ProjectDetails>
